...
<section id="diaszone-hero-slider" class="dz-coverflow relative w-full overflow-hidden py-6 md:py-10" aria-label="{{ __('home.hero_title') }}">
    <div class="swiper diaszone-swiper relative z-0 mx-auto rounded-xl max-w-[95%] xs:max-w-[456px] lg:max-w-[906px] h-[194px] lg:h-[385px]"
                ...
                <div class="swiper-slide">
                    ...
                    @endif
                        @if($img)
                            <img src="{{ $img }}"
                                 alt="{{ $alt }}"
                                 class="dz-coverflow__img object-cover rounded-xl w-full h-[194px] lg:h-[385px]"
                                 width="906"
                                 height="385"
                                 ...
                                 decoding="async">
                        @else
                            <div class="rounded-xl w-full h-[194px] lg:h-[385px] bg-gradient-to-br from-purple-700 to-fuchsia-700"></div>
                        @endif
