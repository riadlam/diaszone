<div id="whatsapp-fab" aria-hidden="false">
    ...
    <a id="whatsapp-fab-link" href="https://wa.me/213556988175" target="_blank" rel="noopener noreferrer" aria-label="{{ __('seller.contact_on_whatsapp', ['phone' => '+213556988175']) }}" class="whatsapp-fab-link" onclick="window.dataLayer && window.dataLayer.push({event:'whatsapp_click'});">
