@if(!empty($topSellingGames) && count($topSellingGames) > 0)
<div class="page-section products-section">
    <div class="products-container">
        <div class="section-header">
            <h2 class="section-title">{{ __('home.top_selling_products') }}</h2>
            <a href="{{ route('shop', ['category' => 'topseller']) }}" class="section-more">
                {{ __('common.view_all') }}
        ...
        <ul class="products-grid">
            @foreach(collect($topSellingGames)->take(16) as $game)
