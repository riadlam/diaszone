...
@section('title', 'Statistics - Seller Panel')
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            @forelse($monthlyStats as $month)
                <div class="flex items-center justify-between p-3 bg-slate-700/50 rounded-lg">
                    <div>
                        ...
                        <p class="text-gray-500 text-sm">{{ $month->orders }} orders</p>
                    </div>
    ...
    <!-- Top Selling Packs -->
    <div class="bg-slate-800 rounded-xl p-6">
        <h3 class="text-lg font-bold mb-4">Top Selling Packs</h3>
        <div class="space-y-3">
            @forelse($topPacks as $index => $item)
                <div class="flex items-center justify-between p-3 bg-slate-700/50 rounded-lg">
                    ...
                    <div class="text-right">
                        <p class="text-white font-medium">{{ $item->count }} sold</p>
...
<!-- 30 Day Chart -->
<div class="bg-slate-800 rounded-xl p-6">
    <h3 class="text-lg font-bold mb-4">Last 30 Days Performance</h3>
    <div class="h-80">
