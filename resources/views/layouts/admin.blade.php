        ...
        <aside class="admin-sidebar w-64 flex-shrink-0 hidden lg:block sticky top-0 h-screen">
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
                    ...
                    <a href="{{ url('/admin/wheel-events') }}" 
                       class="admin-sidebar-item flex items-center space-x-3 px-4 py-3 rounded-lg text-white">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <span class="font-semibold">Lucky Wheel</span>
                    </a>

                    <a href="{{ url('/admin/coupons') }}"
                       class="admin-sidebar-item flex items-center space-x-3 px-4 py-3 rounded-lg text-white {{ request()->is('admin/coupons*') || request()->is('adm/coupons*') ? 'active' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
